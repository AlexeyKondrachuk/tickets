...
export const TrainInfo = () => {
  const {
    ...
    third_seat_type,
    fourth_seat_type,
  } = useAppSelector((state) => state.selectedRoute);

  const station = "вокзал";

  return (
    <div className="train_info_check">
      <div className="passengersInfo_title-wrapper">
        <h4>Поезд</h4>
      </div>
      <section className="route-item-check-container">
...
3.35699 0.976611 0ZM15.0403 2.0167C15.0403 2.99374 15.0403 3.9833 15.0403 4.97286C15.6909 4.97286 16.3165 4.97286 16.9421 4.97286C16.9421 3.97077 16.9421 2.99374 16.9421 2.0167C16.2915 2.0167 15.6909 2.0167 15.0403 2.0167Z"
          ...
          <Link to={`/tickets/`}>
            <button type="button" className="check_update-btn">
              Изменить
            </button>
          </Link>
        </div>
